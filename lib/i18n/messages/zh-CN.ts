...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.extensionRawOutput": "原始输出",
    "chat.extensionOptions": "选项",
    "chat.cancel": "取消",
    "chat.confirm": "确认",
    "chat.submit": "提交",
    ...
    "expert.done": "已完成",
    "expert.failed": "失败",
    "expert.managementEvents": "管理事件",
    "expert.sendToMainAgent": "消息将发送给主 Agent",
    "expert.noTurns": "该专家暂无任务轮次",
    "expert.viewMainSession": "返回主会话",
    "expert.task": "任务",
    "expert.output": "输出",
    "expert.duration": "耗时",
    "expert.selectExpert": "选择专家",
    "expert.clear": "不引用专家",
    "expert.team": "专家团",
    "expert.single": "单个专家",
