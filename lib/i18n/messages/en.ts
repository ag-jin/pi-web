...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.extensionRawOutput": "Raw output",
    "chat.extensionOptions": "Options",
    "chat.cancel": "Cancel",
    ...
    "expert.managementEvents": "Management events",
    "expert.sendToMainAgent": "Messages are sent to the main agent",
    "expert.noTurns": "No task turns for this expert yet",
    "expert.viewMainSession": "Back to main session",
    "expert.task": "Task",
    "expert.output": "Output",
    "expert.duration": "Duration",
    "expert.selectExpert": "Select expert",
    "expert.clear": "No expert reference",
    "expert.team": "Teams",
    "expert.single": "Single experts",
